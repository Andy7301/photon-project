...
- Infer recipientHint and mode from the user's message when obvious; otherwise use "unknown" and "general" or null. Modes include invitation (invite someone to an event) and networking (reach out professionally without a specific job thread).
